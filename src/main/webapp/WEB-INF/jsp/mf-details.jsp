<%-- Document : mf-details Created on : Jul 4, 2026, 12:03:43 PM Author : thisara --%>
    ...
    <%@page contentType="text/html" pageEncoding="UTF-8" %>
        ...
        <body>
                            ...
                            <%@include file="../jspf/topbar.jspf" %>
                                ...
                                <div id="searchContainer" class="d-flex flex-column align-items-center mt-2 mb-2">
                                    <div class="search-box w-50" data-list='{"valueNames":["title"]}'>
                                        <form class="position-relative w-100" data-bs-toggle="search"
                                            data-bs-display="static"><input
                                                ...
                                                placeholder="Search by Finance No, Name, or NIC..."
                                                aria-label="Search" />
                                    ...
                                    <div class="text-500 fs--2 mt-2" id="searchHelpText">
                                        <span class="fas fa-info-circle me-1"></span>Search by <strong>Finance
                                            No</strong>, <strong>Customer Name</strong>, or <strong>NIC</strong>
                                    </div>
                                </div>

                                <div class="card" id="detailsCard" style="display: none;">
                                    <div class="card-header bg-light">
                                        <h5 class="mb-0 text-primary"><span
                                                class="fas fa-info-circle me-2"></span>Contract Information Overview
                                        </h5>
                                    </div>
                                    <div class="card-body">
                                        <div class="row g-3">
                                            <div class="col-6 col-sm-4 col-md-3 col-lg-2 text-center">
                                                <div class="text-500 fs--2 font-sans-serif fw-semi-bold">ACCOUNT NO
                                                </div>
                                                <div class="fs--1 fw-bold val-account-no">-</div>
                                            </div>
                                            <div class="col-6 col-sm-4 col-md-3 col-lg-2 text-center">
                                                <div class="text-500 fs--2 font-sans-serif fw-semi-bold">ACCOUNT STATUS
                                                </div>
                                                <div class="fs--1 fw-bold val-account-status">-</div>
                                            </div>
                                            <div class="col-6 col-sm-4 col-md-3 col-lg-2 text-center">
                                                <div class="text-500 fs--2 font-sans-serif fw-semi-bold">TOTAL
                                                    OUTSTANDING</div>
                                                <div class="fs--1 fw-bold val-outstanding">-</div>
                                            </div>
                                            <div class="col-6 col-sm-4 col-md-3 col-lg-2 text-center">
                                                <div class="text-500 fs--2 font-sans-serif fw-semi-bold">PORTFOLIO
                                                    EXPOSURE</div>
                                                <div class="fs--1 fw-bold val-exposure">-</div>
                                            </div>
                                            <div class="col-6 col-sm-4 col-md-3 col-lg-2 text-center">
                                                <div class="text-500 fs--2 font-sans-serif fw-semi-bold">PERFORMING
                                                    STATUS</div>
                                            ...
                                            <div class="col-6 col-sm-4 col-md-3 col-lg-2 text-center">
                                                <div class="text-500 fs--2 font-sans-serif fw-semi-bold">SECURITY /
                                                    MODEL</div>
                                                <div class="fs--1 fw-bold"><span class="val-security">-</span> / <span
                                                        class="val-model">-</span></div>
                                            </div>
                                            <div class="col-6 col-sm-4 col-md-3 col-lg-2 row-lock-status text-center">
                                                <div class="text-500 fs--2 font-sans-serif fw-semi-bold">LOCK STATUS
                                                </div>
                                                <div class="fs--1 fw-bold val-lock-status">-</div>
                                            </div>
                                            <div
                                                class="col-6 col-sm-4 col-md-3 col-lg-2 row-next-lock-date text-center">
                                                <div class="text-500 fs--2 font-sans-serif fw-semi-bold">NEXT LOCK DATE
                                                </div>
                                                <div class="fs--1 fw-bold val-next-lock-date">-</div>
                                            </div>
                                            <div class="col-6 col-sm-4 col-md-3 col-lg-2 row-device-status text-center"
                                                style="display: none;">
                                                <div class="text-500 fs--2 font-sans-serif fw-semi-bold">CURRENT DEVICE
                                                    STATUS</div>
                                                <div class="fs--1 fw-bold val-device-status">-</div>
                                            </div>
                                            <div class="col-6 col-sm-4 col-md-3 col-lg-2 text-center">
                                                <div class="text-500 fs--2 font-sans-serif fw-semi-bold">FACILITY GRANT
                                                    DATE</div>
                                                <div class="fs--1 fw-bold val-facility-grant-date">-</div>
                                            </div>
                                            <div class="col-6 col-sm-4 col-md-3 col-lg-2 text-center">
                                                <div class="text-500 fs--2 font-sans-serif fw-semi-bold">MATURITY DATE
                                                </div>
                                            ...
                                            <div class="col-6 col-sm-4 col-md-3 col-lg-2 text-center">
                                                <div class="text-500 fs--2 font-sans-serif fw-semi-bold">LOAN AMOUNT
                                                </div>
                                            ...
                                            <div class="col-6 col-sm-4 col-md-3 col-lg-2 text-center">
                                                <div class="text-500 fs--2 font-sans-serif fw-semi-bold">WORKHUB SP NO
                                                </div>
                                    ...
                                    <div class="card-body p-2 px-3">
                                        <div
                                            ...
                                            <div class="d-flex align-items-center gap-2">
                                                <span class="fs-0" id="locks-status-icon"><i
                                            ...
                                            <button type="button" class="btn btn-sm fw-bold transition-all"
                                                id="btn-locks-toggle"
                                                style="border-radius: 4px; font-size: 0.65rem; padding: 2px 10px; min-width: 90px;">
                                                Unlock Device
                                            </button>
                                        </div>
                                    </div>
                                ...
                                <div class="card glass-card mt-3" id="tabsCard" style="display: none;">
                                    <div class="card-header p-0 border-bottom border-200">
                                        <ul class="nav nav-tabs border-0" id="detail-tabs-list" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link active" id="tab-cust" data-bs-toggle="tab"
                                                    href="#cust-pane" role="tab" aria-controls="cust-pane"
                                                    aria-selected="true">
                                                    <span class="fas fa-user me-2"></span>Customer Details
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" id="tab-guarantor" data-bs-toggle="tab"
                                                    href="#guar-pane" role="tab" aria-controls="guar-pane"
                                                    aria-selected="false">
                                                    <span class="fas fa-users me-2"></span>Guarantor Details
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" id="tab-statement" data-bs-toggle="tab"
                                                    href="#stat-pane" role="tab" aria-controls="stat-pane"
                                                    aria-selected="false">
                                                    <span class="fas fa-file-invoice-dollar"></span>Account Statement
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" id="tab-payments" data-bs-toggle="tab"
                                                    href="#pay-pane" role="tab" aria-controls="pay-pane"
                                                    aria-selected="false">
                                                    <span class="fas fa-receipt me-2"></span>Payments
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" id="tab-sms" data-bs-toggle="tab" href="#sms-pane"
                                                    role="tab" aria-controls="sms-pane" aria-selected="false">
                                                    <span class="fas fa-sms me-2"></span>SMS Logs
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" id="tab-locks" data-bs-toggle="tab"
                                                    href="#locks-pane" role="tab" aria-controls="locks-pane"
                                                    aria-selected="false">
                                                    <span class="fas fa-lock me-2"></span>Lock/Unlock Logs
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" id="tab-remarks" data-bs-toggle="tab"
                                                    href="#remarks-pane" role="tab" aria-controls="remarks-pane"
                                                    aria-selected="false">
                                    ...
                                    <div class="card-body p-3">
                                        <div class="tab-content" id="detail-tabs-content">
                                            ...
                                            <div class="tab-pane fade show active" id="cust-pane" role="tabpanel"
                                                aria-labelledby="tab-cust">
                                                <div class="table-responsive">
                                                    <table class="table table-striped table-hover mb-0 fs--1">
                                                        <tbody>
                                                            <tr>
                                                                <td class="bg-100 fw-bold" style="width: 20%;">NIC:</td>
                                                                <td class="text-600"><span id="val-cust-nic">-</span>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="bg-100 fw-bold" style="width: 20%;">Name:
                                                                </td>
                                                                <td class="text-600"><span id="val-cust-name">-</span>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="bg-100 fw-bold" style="width: 20%;">Address:
                                                                </td>
                                                                <td class="text-600"><span
                                                                        id="val-cust-address">-</span></td>
                                                            </tr>
                                                            <tr>
                                                                <td class="bg-100 fw-bold" style="width: 20%;">Mobile
                                                                    No:</td>
                                                                <td><a class="text-600 text-decoration-none fw-bold"
                                                                        id="val-cust-mobile-link" href="#"><span
                                                                            id="val-cust-mobile">-</span></a></td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </div>
                                            ...
                                            <div class="tab-pane fade" id="guar-pane" role="tabpanel"
                                                aria-labelledby="tab-guarantor">
                                                <div id="guarantors-wrapper">
                                                    <!-- Dynamically filled -->
                                                </div>
                                            </div>
                                            <!-- Account Statement pane -->
                                            <div class="tab-pane fade" id="stat-pane" role="tabpanel"
                                                ...
                                                <div class="text-center mt-3" id="stmt-load-more-container"
                                                    ...
                                                    <button class="btn btn-sm btn-outline-primary fw-bold px-4"
                                                        id="btn-stmt-load-more" onclick="loadMoreStatementMonths()"
                                            ...
                                            <div class="tab-pane fade" id="remarks-pane" role="tabpanel"
                                                aria-labelledby="tab-remarks">
                                                <div class="mb-3">
                                                    <form id="remark-form">
                                                        <div class="input-group">
                                                            <input type="text" id="remark-input" class="form-control"
            ...
            <div id="detailsLoader"
                style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(255,255,255,0.4); z-index: 9999; justify-content: center; align-items: center; backdrop-filter: blur(8px); -webkit-backdrop-filter: blur(8px); transition: all 0.3s ease;">
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="smsModalLabel"><span
                                    class="fas fa-sms me-2 text-primary"></span>Full Message Details</h5>
