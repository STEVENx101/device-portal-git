                    ...
                    <div class="card-body p-3">
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                ...
                                <h3 class="fw-bold mb-0 text-success font-sans-serif" id="stat-outstanding">LKR 0.00
                                </h3>
                            </div>
        ...
        <div class="row g-3 mb-3">
            <div class="col-md-5">
                <div class="card h-100">
                    <div class="card-header bg-light d-flex align-items-center justify-content-between py-2">
                        <h6 class="mb-0 text-800 fw-semi-bold"><span
                                class="fas fa-shield-alt me-2 text-primary"></span>Device Security Model Breakdown</h6>
                    </div>
            ...
            <div class="col-md-7">
                <div class="card h-100">
                    <div class="card-header bg-light d-flex align-items-center justify-content-between py-2">
                        <h6 class="mb-0 text-800 fw-semi-bold"><span
                                class="fas fa-history me-2 text-primary"></span>Recent Device Lock / Unlock logs</h6>
                    </div>
