...
<html lang="en-US" dir="ltr">
    ...
    <head>
        ...
        <title>Fintrex | Client Report</title>
    ...
    <body>
            ...
            <div class="container" data-layout="container">
                ...
                <div class="content">
                    ...
                    <div class="d-flex mb-2 align-items-center justify-content-between mt-2">
                        <div>
                            <h4 class="mb-0 text-primary"><i class="fas fa-file-invoice-dollar me-2"></i>Device Finance Reports - Client</h4>
                        </div>
                    </div>
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                dtReport = $('#tableReport2').DataTable({
                    processing: false,
                    serverSide: true,
                    deferLoading: true,
                    ajax: function(data, callback, settings) {
                        ...
                        $.ajax({
                            url: '${pageContext.request.contextPath}/api/cbs/report2',
                            type: 'POST',
