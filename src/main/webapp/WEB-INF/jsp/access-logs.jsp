...
<html lang="en-US" dir="ltr">
    ...
    <head>
        ...
        <title>Fintrex | Screen Access Logs</title>
            ...
            <div class="container" data-layout="container">
                ...
                <div class="content">
                    ...
                    <div class="d-flex mb-3 align-items-center justify-content-between mt-2">
                        <div>
                            <h4 class="mb-0 text-primary"><i class="fas fa-user-shield me-2"></i>Screen Access Activity Logs</h4>
                        </div>
                    </div>
            ...
            $(document).ready(function() {
                $('#tableLogs').DataTable({
                    ...
                    ajax: function(data, callback, settings) {
                        $.ajax({
                            url: '${pageContext.request.contextPath}/api/cbs/access-logs',
                            type: 'POST',
