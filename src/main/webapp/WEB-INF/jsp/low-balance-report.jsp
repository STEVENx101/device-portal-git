...
<html lang="en-US" dir="ltr">
    ...
    <head>
        ...
        <title>Fintrex | Low Balance</title>
            ...
            <div class="container" data-layout="container">
                ...
                <div class="content">
                    ...
                    <div class="d-flex mb-2 align-items-center justify-content-between mt-2">
                        <div>
                            <h4 class="mb-0 text-primary"><i class="fas fa-percent me-2"></i>Exception Reports - Low Balance Report</h4>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <form id="filterForm">
                                <div class="row g-3 align-items-end">
                                     ...
                                     <div class="col-md-2">
                                         <label class="form-label text-700 fw-semi-bold" for="maturityStatus">Maturity Status</label>
                                         <select class="form-select" id="maturityStatus">
                                             <option value="ALL" selected>All</option>
                                             <option value="MATURED">Matured</option>
                                             <option value="NON_MATURED">Non-Matured</option>
                                         </select>
                                     </div>
                                     <div class="col-md-2">
                    ...
                    <div class="card glass-card mb-3" style="position: relative; z-index: 1;">
                        <div class="card-body p-3">
                            <div class="table-responsive scrollbar">
                                <table class="table table-hover table-striped align-middle mb-0 fs--1 w-100" id="tableLowBalance">
        ...
        <script>
            ...
            function getFilters() {
                ...
                return {
                    ...
                    maturityStatus: $('#maturityStatus').val(),
                    products: products
                };
            }
            ...
            $(document).ready(function() {
                ...
                dtReport = $('#tableLowBalance').DataTable({
                    processing: false,
                    serverSide: true,
                    deferLoading: true,
                    ordering: false,
                    ajax: function(data, callback, settings) {
                        ...
                        $.ajax({
                            url: '${pageContext.request.contextPath}/api/cbs/low-balance',
                            type: 'POST',
                ...
                $('#tableLowBalance tbody').on('click', 'tr', function () {
                ...
                if ($('#downloadExcelBtn').length) {
                    $('#downloadExcelBtn').on('click', function() {
                        ...
                        let downloadUrl = '${pageContext.request.contextPath}/api/cbs/low-balance/download';
                        ...
                        if (filters.maturityStatus) {
                            queryParams.append('maturityStatus', filters.maturityStatus);
                        }
