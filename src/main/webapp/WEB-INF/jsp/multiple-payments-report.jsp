...
<html lang="en-US" dir="ltr">
    ...
    <head>
        ...
        <title>Fintrex | Multiple Payments</title>
    ...
    <body>
            ...
            <div class="container" data-layout="container">
                ...
                <div class="content">
                    ...
                    <div class="d-flex mb-2 align-items-center justify-content-between mt-2">
                        <div>
                            <h4 class="mb-0 text-primary"><i class="fas fa-history me-2"></i>Exception Reports - Multiple Payments in a Day</h4>
                        </div>
                    </div>
                    ...
                    <div class="card glass-card mb-3" style="position: relative; z-index: 1;">
                        <div class="card-body p-3">
                            <div class="table-responsive scrollbar">
                                <table class="table table-hover table-striped align-middle mb-0 fs--1 w-100" id="tableMultiplePayments">
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                dtReport = $('#tableMultiplePayments').DataTable({
                    processing: false,
                    serverSide: true,
                    deferLoading: true,
                    ordering: false,
                    ajax: function(data, callback, settings) {
                        ...
                        $.ajax({
                            url: '${pageContext.request.contextPath}/api/cbs/multiple-payments-report',
                            type: 'POST',
                    ...
                    columns: [
                        ...
                        { 
                            data: 'same_amount_duplicate',
                            render: function(data) {
                                if (data === 'Yes') {
                                    return '<span class="badge bg-danger">Duplicate Amount</span>';
                                }
                    ...
                    createdRow: function(row, data, dataIndex) {
                        if (data.same_amount_duplicate === 'Yes') {
                ...
                $('#tableMultiplePayments tbody').on('click', 'tr', function () {
                ...
                if ($('#downloadExcelBtn').length) {
                    $('#downloadExcelBtn').on('click', function() {
                        ...
                        let downloadUrl = '${pageContext.request.contextPath}/api/cbs/multiple-payments-report/download';
