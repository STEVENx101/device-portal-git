...
<html lang="en-US" dir="ltr">
    ...
    <head>
        ...
        <title>Fintrex | Role Permission Logs</title>
            ...
            <div class="container" data-layout="container">
                ...
                <div class="content">
                    ...
                    <div class="d-flex mb-3 align-items-center justify-content-between mt-2">
                        <div>
                            <h4 class="mb-0 text-primary"><i class="fas fa-key me-2"></i>Role Permission Logs</h4>
                        </div>
                    </div>
            ...
            $(document).ready(function() {
                $('#tableLogs').DataTable({
                    ...
                    ajax: function(data, callback, settings) {
                        $.ajax({
                            url: '${pageContext.request.contextPath}/api/cbs/permission-logs',
                            type: 'POST',
                    ...
                    columns: [
                        ...
                        { 
                            ...
                            render: function(data) {
                                return '<span class="badge badge-role">' + (data || 'Unknown') + '</span>';
                            }
                        },
                        { data: 'action_details' },
                        { data: 'created_date' }
