    ...
    <body>
                    ...
                    <div class="card glass-card mb-3" style="position: relative; z-index: 1;">
                        <div class="card-body p-3">
                            <div class="table-responsive scrollbar">
                                <table class="table table-hover table-striped align-middle mb-0 fs--1 w-100" id="tableOneRental">
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                dtReport = $('#tableOneRental').DataTable({
                    processing: false,
                    serverSide: true,
                    deferLoading: true,
                    ordering: false,
                    ajax: function(data, callback, settings) {
                        ...
                        $.ajax({
                            url: '${pageContext.request.contextPath}/api/cbs/one-rental',
                            type: 'POST',
                ...
                $('#tableOneRental tbody').on('click', 'tr', function () {
                ...
                if ($('#downloadExcelBtn').length) {
                    $('#downloadExcelBtn').on('click', function() {
                        ...
                        let downloadUrl = '${pageContext.request.contextPath}/api/cbs/one-rental/download';
