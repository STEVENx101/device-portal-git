...
<html lang="en-US" dir="ltr">
    ...
    <head>
        ...
        <title>Fintrex | Vendor Payment Exceptions</title>
    ...
    <body>
            ...
            <div class="container" data-layout="container">
                ...
                <div class="content">
                    ...
                    <div class="d-flex mb-2 align-items-center justify-content-between mt-2">
                        <div>
                            <h4 class="mb-0 text-danger"><i class="fas fa-exclamation-triangle me-2"></i>Exception Reports - Vendor Payment Exceptions</h4>
                        </div>
                    </div>
                    ...
                    <div class="row row-cols-1 row-cols-sm-3 g-3 mb-3">
                        <div class="col">
                            <div class="kpi-card border-start border-4 border-danger">
                                <div class="kpi-title"><i class="fas fa-exclamation-circle me-1 text-danger"></i>Total Exceptions</div>
                                <div class="kpi-value text-danger" id="kpiTotalAmount">LKR 0.00</div>
                        ...
                        <div class="col">
                            <div class="kpi-card border-start border-4 border-warning">
                                <div class="kpi-title"><i class="fas fa-clock me-1 text-warning"></i>Pending Exceptions</div>
                        ...
                        <div class="col">
                            <div class="kpi-card border-start border-4 border-dark">
                                <div class="kpi-title"><i class="fas fa-times-circle me-1 text-dark"></i>Failed Exceptions</div>
                                <div class="kpi-value text-dark" id="kpiFailedAmount">LKR 0.00</div>
                        ...
                        <div class="card-body py-2">
                            <form id="filterForm">
                                <div class="row g-2 align-items-center">
                                    ...
                                    <div class="col-md-2">
                                        <label class="form-label text-700 fw-semi-bold mb-1 fs--1">Exception Status</label>
                                        <select class="form-select form-select-sm" id="statusSelect">
                                            <option value="ALL" selected>Pending &amp; Failed</option>
                    ...
                    <div class="card glass-card mb-3" style="position: relative; z-index: 1;">
                        <div class="card-body p-3">
                            <div class="table-responsive scrollbar">
                                <table class="table table-hover table-striped align-middle mb-0 w-100 fs--1" id="tableVendorPaymentsException">
        ...
        <script>
            ...
            function loadReportData() {
                ...
                if (dataTable) {
                    dataTable.destroy();
                    $('#tableVendorPaymentsException tbody').empty();
                }
                ...
                $.ajax({
                    url: '${pageContext.request.contextPath}/api/cbs/vendor-payments-exception',
                    type: 'POST',
                    ...
                    success: function(res) {
                        ...
                        const excAmount = (totals.pendingAmount || 0) + (totals.failedAmount || 0);
                        const excCount = (totals.pendingCount || 0) + (totals.failedCount || 0);

                        $('#kpiTotalAmount').text('LKR ' + formatNumber(excAmount));
                        $('#kpiTotalCount').text(excCount + ' Exceptions');
                        ...
                        dataTable = $('#tableVendorPaymentsException').DataTable({
                            data: rows,
                            columns: [
                                { data: 'trx_date' },
                                ...
                                { 
                                    ...
                                    render: function(d) {
                                        let bg = 'bg-secondary';
                                        if (d === 'Pending') bg = 'bg-warning text-dark';
                            ...
                            order: [[0, 'desc']],
                            language: {
                                emptyTable: 'No pending or failed vendor payment exceptions found for the selected filter criteria'
                            }
                        });
                    },
                    error: function(err) {
                        console.error("Failed to load vendor payment exceptions:", err);
                    },
                    complete: function() {
                        $('#cbsLoader').hide();
                    }
            ...
            $(document).ready(function() {
                ...
                $('#downloadCsvBtn').on('click', function() {
                    ...
                    window.location.href = '${pageContext.request.contextPath}/api/cbs/vendor-payments-exception/download?' + queryStr;
