...
<html lang="en-US" dir="ltr">
    ...
    <head>
        ...
        <title>Fintrex | Settled & Early Settled</title>
            ...
            <div class="container" data-layout="container">
                ...
                <div class="content">
                    ...
                    <div class="d-flex mb-2 align-items-center justify-content-between mt-2">
                        <div>
                            <h4 class="mb-0 text-primary"><i class="fas fa-check-circle me-2"></i>Exception Reports - Settled & Early Settled</h4>
                        </div>
                    </div>
                    ...
                    <div class="card glass-card mb-3" style="position: relative; z-index: 1;">
                        <div class="card-body p-3">
                            <div class="table-responsive scrollbar">
                                <table class="table table-hover table-striped align-middle mb-0 fs--1 w-100" id="tableSettled">
            ...
            $(document).ready(function() {
                ...
                dtReport = $('#tableSettled').DataTable({
                    ...
                    ajax: function(data, callback, settings) {
                        ...
                        $.ajax({
                            url: '${pageContext.request.contextPath}/api/cbs/settled-report',
                            type: 'POST',
                ...
                $('#tableSettled tbody').on('click', 'tr', function () {
