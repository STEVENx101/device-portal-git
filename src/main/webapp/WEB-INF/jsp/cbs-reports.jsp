            ...
            <div class="container" data-layout="container">
                ...
                <div class="content">
                    ...
                    <div class="d-flex mb-3 align-items-center justify-content-between">
                        <div>
                            <h4 class="mb-1 text-primary"><i class="fas fa-file-invoice-dollar me-2"></i>CBS Core Reports</h4>
                    ...
                    <div class="card glass-card mb-4">
                        ...
                        <div class="card-body">
                            <form id="filterForm">
                                <div class="row g-3">
                                    <div class="col-md-3">
                                        <label class="form-label text-700 fw-semi-bold" for="reportType">Report Type</label>
                    ...
                    <div class="card glass-card" id="tabsCard">
                        <div class="card-header p-0 border-bottom border-200">
                            <ul class="nav nav-tabs border-0" id="reportTabs" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="tab-report1" data-bs-toggle="tab" href="#report1-pane" role="tab" aria-controls="report1-pane" aria-selected="true">
                                        <span class="fas fa-link me-2"></span>Portfolio
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="tab-report2" data-bs-toggle="tab" href="#report2-pane" role="tab" aria-controls="report2-pane" aria-selected="false">
                        ...
                        <div class="card-body p-0">
                            <div class="tab-content">
                                <!-- Report 1 Pane -->
                                <div class="tab-pane fade show active" id="report1-pane" role="tabpanel" aria-labelledby="tab-report1">
                                ...
                                <!-- Report 2 Pane -->
                                <div class="tab-pane fade" id="report2-pane" role="tabpanel" aria-labelledby="tab-report2">
                                    <div class="table-responsive scrollbar">
                                        <table class="table table-hover table-striped align-middle mb-0 fs--1 w-100" id="tableReport2">
                                            <thead class="bg-200 text-900">
                                                <tr>
                                                    <th>Client Code</th>
                                                    <th>Type</th>
                                ...
                                <!-- Report 3 Pane -->
                                <div class="tab-pane fade" id="report3-pane" role="tabpanel" aria-labelledby="tab-report3">
                                    <div class="table-responsive scrollbar">
