...
public class DashboardRepository {
    ...
    public Map<String, Object> getDashboardStats() {
        ...
        // 4. Device Locked & Unlocked Counts (Laptop vs Mobile) - Optimized fallback index joins
        ...
        stats.put("currentMonthDealers", currentMonthDealers);
        stats.put("portfolioDealers", portfolioDealers);

        // 7. Arrears Analysis (by product) - Optimized fallback join
        List<Map<String, Object>> arrearsAnalysis = jdbcTemplate.queryForList(
        ...
        stats.put("arrearsAnalysis", arrearsAnalysis);

        // 8. DPD Analysis buckets
        List<Map<String, Object>> dpdAnalysis = jdbcTemplate.queryForList(
        ...
        stats.put("dpdAnalysis", dpdAnalysis);

        // 9. Highest NPL model - Optimized fallback join
        ...
        stats.put("highestNplModels", highestNplModels);

        // 10. Highest NPL Dealer - Optimized fallback join
        ...
        stats.put("highestNplDealers", highestNplDealers);

        // 11. Collections Dealer Wise - Optimized fallback join
        ...
        stats.put("collectionsDealerWise", collectionsDealerWise);
